...
const Privacy = () => {
  return (
    <div className="pt-2 ps-2">
      ...
      <h2 className="font-bold pb-2">1. Общие положения</h2>
      ...
      <p className="pb-2">
        ...
        безопасности персональных данных, предпринимаемые Голованёвым Егором
        Евгеньевичем (далее — Оператор).
      </p>
      <p className="pb-2 ps-4">
      ...
      <p className="pb-2 ps-4">
        ...
        https://store-it-from-github-wrong-name-in-appwrite.vercel.app/.
      </p>
      ...
      <p className="pb-2 ps-4">3.1. Оператор имеет право:</p>
      <p className="pb-2 ps-4">
      ...
      <p className="pb-2 ps-4">3.2. Оператор обязан:</p>
      <p className="pb-2 ps-4">
      ...
      <p className="pb-2 ps-4">4.2. Субъекты персональных данных обязаны:</p>
      <p className="pb-2 ps-4">
      ...
      <h2 className="font-bold pb-2">6. Цели обработки персональных данных</h2>

      <div className="ps-4 pb-2">
        <Table>
          <TableBody>
            <TableRow>
              <TableHead className="w-[300px]">Цель обработки</TableHead>
              <TableCell>
            ...
            <TableRow>
              <TableHead>Персональные данные</TableHead>
              <TableCell>электронный адрес</TableCell>
            </TableRow>
            <TableRow>
              <TableHead>Правовые основания</TableHead>
              <TableCell>
                Федеральный закон "О персональных данных" от 27.07.06 N 152 -ФЗ
              </TableCell>
            </TableRow>
            <TableRow>
              <TableHead>Виды обработки персональных данных</TableHead>
              <TableCell>
                <ul className="list-disc">
                  ...
                  <li>Отправка одноразовых кодов аутентификации</li>
                </ul>
              </TableCell>
            </TableRow>
          </TableBody>
        ...
        <Table>
          <TableBody>
            <TableRow>
              <TableHead className="w-[300px]">Цель обработки</TableHead>
              <TableCell>
                Отображение персональной информации в профиле Пользователя
              </TableCell>
            </TableRow>
            <TableRow>
              <TableHead>Персональные данные</TableHead>
      ...
      <p className="pb-2 ps-4">
        ...
        уведомление на адрес электронной почты Оператора qwerty@mail.ru с
      ...
      <p className="pb-2 ps-4">
        ...
        электронный адрес Оператора qwerty@mail.ru с пометкой «Отзыв согласия на
      ...
      <h2 className="font-bold pb-2">12. Заключительные положения</h2>
      ...
      <p className="pb-2 ps-4">
        ...
        Оператору с помощью электронной почты qwerty@mail.ru
      </p>
      <p className="pb-2 ps-4">
      ...
      <p className="pb-2 ps-4">
        ...
        Интернет по адресу
        https://store-it-from-github-wrong-name-in-appwrite.vercel.app/privacy.
      </p>
    </div>
  );
};
